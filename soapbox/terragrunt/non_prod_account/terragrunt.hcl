# The root terragrunt.hcl containing the configuration applicable to all non-prod account and environments (dev, qa)
...
provider "aws" {
  ...
  default_tags {
    tags = {
      ...
      cost-center = "${local.project_name} ${local.app_id}"
